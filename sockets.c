 ...
 */
 ...
 /*
  * HTTP headers:
  *  - Device-Token: authentication for TagoIO
  *  - Content-Type: JSON payload
  *  - Connection: close to force server to close socket after response
  *  - _ssl: false tells Zephyr HTTP client not to use TLS
  */
