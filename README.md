...
Nelson - Nelson configured an ESP32-CAM module to recognise playing cards in real time. He leveraged Edge Impulse’s APIs to train and deploy a card-detection model on the device. As each card was identified, its value was encoded into the “major” field of an iBeacon packet and broadcast wirelessly to the base node.
